      ...
      <div class="container">
        <div class="row">
          <div class="col l6 s12">
            ...
            <p class="grey-text text-lighten-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc vel arcu erat. In ullamcorper turpis at odio lacinia, ac pulvinar mi dignissim. Proin at mauris dapibus, finibus tellus tristique, eleifend mauris</p>
          </div>
        </div>
      </div>
      <div class="footer-copyright">
        <div class="container">
          © 2019 <a class="grey-text text-lighten-4" href="https://hacktiv8.com" target="_blank">FSD1</a>
          <a class="grey-text text-lighten-4 right footerLink" href="" target="_blank">Github</a>
          <a class="grey-text text-lighten-4 right footerLink" href="" target="_blank">LinkedIn</a>
          <a class="grey-text text-lighten-4 right footerLink" href="" target="_blank">Twitter</a>
        </div>
      </div>
    </footer>
